...
-- Procédure stockée: Finaliser une commande et vider le panier
DELIMITER //
...
-- Procédure stockée: Afficher l'historique des commandes d'un client
DELIMITER //
...
-- Trigger: Mettre à jour le stock après la validation d'une commande
DELIMITER //
...
-- Trigger: Empêcher l'insertion si la quantité demandée dépasse le stock disponible
DELIMITER //
...
-- Trigger: Restaurer le stock après l'annulation d'une commande
DELIMITER //
...
-- Trigger: Garder trace des commandes annulées
DELIMITER //
